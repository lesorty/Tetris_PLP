...
/* package Tetris-PLP-0.1.0.0 */
#ifndef VERSION_Tetris_PLP
#define VERSION_Tetris_PLP "0.1.0.0"
#endif /* VERSION_Tetris_PLP */
#ifndef MIN_VERSION_Tetris_PLP
#define MIN_VERSION_Tetris_PLP(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_Tetris_PLP */
...
#define CURRENT_COMPONENT_ID "Tetris-PLP-0.1.0.0-inplace-Tetris-PLP"
